...
const I18N = {
  fr: {
    ...
    role: 'UX/UI Designer',
    location: 'Paris, FR',
    bio: "J'ai toujours trouvé les apps intuitives, jusqu'au jour où j'ai compris pourquoi. Aujourd'hui, je suis UX/UI Designer basé à Paris et je conçois des expériences de bout en bout, avec autant de soin que si c'était pour moi. Car derrière chaque interface, il y a une vraie personne.",
